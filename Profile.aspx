<%@ Page Title="Profile" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Profile.aspx.vb" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="conatiner">
        <div class="top-buttons">
            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/edit.png" 
                Width="30px" /> &nbsp;&nbsp;&nbsp;&nbsp;
